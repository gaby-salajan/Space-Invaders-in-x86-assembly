...
destroy_alien_macro macro bulletX, bulletY, alien_Y , state4, state5, state6, state7
local destroy4
local destroy5
local destroy6
local destroy7
...
afisare_litere:
	...
	row1:
		destroy_alien_macro bullet_x, bullet_y, alien1_y, state14, state15, state16, state17 
	
	row2:
		destroy_alien_macro bullet_x, bullet_y, alien2_y, state24, state25, state26, state27
	
	row3:
		destroy_alien_macro bullet_x, bullet_y, alien3_y, state34, state35, state36, state37
		
	row4:
		destroy_alien_macro bullet_x, bullet_y, alien4_y, state44, state45, state46, state47
